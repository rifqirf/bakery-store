...
class Penjualan extends CI_Controller {
	...
	public function get() {
      ...
      "data" => []
        ...
        $this->db->join("toko", "toko.id_toko=penjualan.id_toko", "left")
                ->join("customer", "customer.id_pembeli=penjualan.id_pembeli", "left")
                ->join("status", "status.status=penjualan.status", "left");
